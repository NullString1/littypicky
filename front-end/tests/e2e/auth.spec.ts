...
import { registerUser, login, logout, isLoggedIn, verifyEmailViaAPI, registerAndLoginVerifiedUser } from './helpers/auth-helpers';
...
test.describe('Authentication', () => {
	...
	test.describe('User Login', () => {
		...
		await expect(page.locator('h2:has-text("Litter Feed")')).toBeVisible({ timeout: 10000 });
	...
	test.describe('Email Verification', () => {
		...
		test.skip('should show error for invalid verification token', async ({ page }) => {
			// TODO: Implement this test
		});
	});
	...
	test.describe('Password Reset', () => {
		test('should request password reset', async ({ page }) => {
			...
			await expect(page.locator('text=/password.*reset.*sent|check.*email/i')).toBeVisible();
