    ...
    <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-slate-200">
      ...
      <form class="space-y-6" onsubmit={handleSubmit}>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="/auth/forgot-password" class="font-medium text-primary-600 hover:text-primary-500"> Forgot your password? </a>
          </div>
        </div>
      ...
      <div class="mt-6">
        ...
        <div class="mt-6">
          <a href="http://localhost:5173/api/auth/google" class="w-full inline-flex justify-center py-2 px-4 border border-slate-300 rounded-md shadow-sm bg-white text-sm font-medium text-slate-500 hover:bg-slate-50">
